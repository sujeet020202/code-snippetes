      ...
      <div class="row">
                        ...
                        <div data-plugin-options="{&quot;directionNav&quot;:true}" class="flexslider">
                          <div class="flex-viewport" style="overflow: hidden; position: relative;">
                            <ul class="slides" style="width: 800%; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);">
                              <li style="width: 328px; float: left; display: block;" class="flex-active-slide"> <img src="<?=base_url('media/'.$blog['content_image'])?>"  draggable="false"> </li>
        ...
        <div class="col-md-3">
          <aside class="sidebar">
            ...
            <?php
			if(!empty($all_data)){
				$all_data = _group_by($all_data,array('category_name','category_slug'));
				$i= 1;
				$categories = array_keys($all_data);
				echo '<ul class="nav nav-list blog-categories">';
				foreach($categories as $category){
					$category_data = explode('###',$category);
					echo '<li> <a href="'.site_url('cms_demo/category/'.$category_data[1]).'"> '.$category_data[0].' </a> </li>';
				}
				echo '</ul>';
			}
